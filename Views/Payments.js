...
import PaymentTecnicoValidado from '../Views/PaymentTecnicoValidado';
import PaymentCliente from '../Views/PaymentCliente'; 
import PaymentAdministrador from '../Views/PaymentAdministrador'; 
import PaymentAnalista from '../Views/PaymentAnalista'; 
    ...
    const transl = require('../Controllers/traductor.json');
      ...
      // {transl[lang]['inicio_b1']}
                  ...
                  return (  <ImageBackground source={{uri: 'https://clicwash.com/img/fondo_perfil_app.jpg'}} style={styles.container}>
                   ...
                   <PaymentAdministrador tecnico_foto_id={this.state.tecnico_foto_id}  contrasena={this.state.contrasena}  correo={this.state.correo} telefono_1={this.state.telefono_1} navigation={this.props.navigation}/>
                  ...
                  <PaymentAnalista tecnico_foto_id={this.state.tecnico_foto_id}  contrasena={this.state.contrasena}  correo={this.state.correo} telefono_1={this.state.telefono_1} navigation={this.props.navigation}/> 
                        ...
                        if (this.state.validado==0) {
                          ...
                          <InicioNumeroNoValidado tecnico_foto_id={this.state.tecnico_foto_id}  contrasena={this.state.contrasena}  correo={this.state.correo} telefono_1={this.state.telefono_1} navigation={this.props.navigation}/>  
                          ...
                          <PaymentCliente tecnico_foto_id={this.state.tecnico_foto_id}  contrasena={this.state.contrasena}  correo={this.state.correo} telefono_1={this.state.telefono_1} navigation={this.props.navigation}/> 
                          ...
                          <InicioNumeroNoValidado tecnico_foto_id={this.state.tecnico_foto_id}  contrasena={this.state.contrasena}  correo={this.state.correo} telefono_1={this.state.telefono_1} navigation={this.props.navigation}/> 
                                  ...
                                  if (this.state.tecnico_status_solicitud!=0) {
                                    ...
                                    <ImageBackground source={{uri: 'https://clicwash.com/img/fondo_perfil_app.jpg'}} style={styles.container}>
                                     ...
                                     <PaymentTecnicoValidado Id_Global={this.state.Id_Global}  tecnico_foto_id={this.state.tecnico_foto_id}  contrasena={this.state.contrasena}  correo={this.state.correo} telefono_1={this.state.telefono_1} navigation={this.props.navigation}/> 
                                    ...
                                    <ImageBackground source={{uri: 'https://clicwash.com/img/fondo_perfil_app.jpg'}} style={styles.container}>
                                     ...
                                     <InicioTecnicoNoValidado Id_Global={this.state.Id_Global} tecnico_foto_id={this.state.tecnico_foto_id}  contrasena={this.state.contrasena}  correo={this.state.correo} telefono_1={this.state.telefono_1} navigation={this.props.navigation}/> 
